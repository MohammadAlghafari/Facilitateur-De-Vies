...
abstract class UserProfileRepository {
  ...
  Future<Either<dynamic,ApiResponse<String>>> deleteAccount({required String id,});

  Future<Either<dynamic,ApiResponse<AccountModel>>> getAccount();

  Future<Either<dynamic,ApiResponse<SuccessResponseModel>>> updateAccount({required AccountModel accountModel,required int id});
